 ...
 namespace Data
{
    ...
    public sealed class Adapter
    {
        ...
        {
            get { return new System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings["conn_str"].ToString()); }
        }
        ...
        //DrBatraData.Adapter.AddParam(pcol, "@Clnc_Id", 4);
        //DrBatraData.Adapter.AddParam(pcol, "@Clnc_Name", "EAST");        
        //DrBatraData.Adapter.AddParam(pcol, "@Clnc_Code", "EAST");        
        //DrBatraData.Adapter.AddParam(pcol, "@BranchStTime", Convert.ToDateTime("2007-04-01 09:00:00.000"));     
        //dt = DrBatraData.Adapter.ExecuteDataTable("test_branchList", CommandType.StoredProcedure, DrBatraData.Adapter.param(pcol));   
